...
export default {
  data () {
    return {
      ...
      imgList: [
        ...
        'https://img.meituan.net/kylisean/8152e1da54ae18b95ddb6f2be33cb62098729.jpg@750w_150h_1c_1e'
      ],
      p: 1
    }
  },
  ...
  methods: {
    onLoad () {
      console.log('到底了')
      this.p++
      http.get(`https://show.maoyan.com/maoyansh/myshow/ajax/performances/9;st=0;p=${this.p};s=20;tft=0;marketLevel=0?sellChannel=13&cityId=1&lng=0&lat=0`).then(res => {
  ...
  mounted () {
    ...
    http({
      url: 'https://show.maoyan.com/maoyansh/myshow/ajax/performances/9;st=0;p=1;s=20;tft=0;marketLevel=0?sellChannel=13&cityId=1&lng=0&lat=0',
      method: 'get'
    }).then(res => {
